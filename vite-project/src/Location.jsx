                ...
                <div className="box">
                    ...
                    <div className="content-1">
                        <h2>Where Do you live!</h2>
                         ...
                         <input type="text" placeholder="Enter your Home name and number" />
                         <h3>District</h3>
                         ...
                         <h3>Village</h3>
                         <input type="text" placeholder="Village"  style={{marginBottom:"30px"}}/>
                     <Link to="/Contact"><button>Save</button></Link>    
                    </div>
                </div>
